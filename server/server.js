...
app.get('/', (req, res) => res.status(200).send({ message: 'Hello from Chatty!' })) // Test endpoint
...
app.listen(3000, () => console.log('AI server started on http://localhost:3000')); // Start the server